...
# HOLD ON, ISN'T THERE A MUCH SIMPLER WAY TO DO THIS?
# YOU KNOW, WHERE YOU CAN JUST USE FLOAT/INTERGER ADDITION INSTEAD OF STRING EDITING?!?
# DANGIT MAN
# I have no motivation to create another version using the simpler version though.